<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Web.Account.Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Use a American Water local account to log in.</h4>
                    <hr />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtUserID" CssClass="form-control" /><span>Please insert Domain\User Name</span>
